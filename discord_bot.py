...
"""
First Time Played -- data["player"]["firstLogin"]
Last Time Played -- data["player"]["lastLogin"]
Skywars Souls -- data["player"]["stats"]["SkyWars"]["souls"]
Skywars Coins -- data["player"]["stats"]["SkyWars"]["coins"]
SkyWars Experience -- data["player"]["stats"]["SkyWars"]["skywars_experience"]
Skywars Blocks Broken -- data["player"]["stats"]["SkyWars"]["blocks_broken"]
Skywars Blocks Placed -- data["player"]["stats"]["SkyWars"]["blocks_placed"]
Skywars Chests Opened -- data["player"]["stats"]["SkyWars"]["chests_opened"]
Skywars Deaths -- data["player"]["stats"]["SkyWars"]["deaths"]
Skywars Deaths Solo -- data["player"]["stats"]["SkyWars"]["deaths_solo"]
Skywars Deaths Solo Normal -- data["player"]["stats"]["SkyWars"]["deaths_solo_normal"]
Skywars Losses -- data["player"]["stats"]["SkyWars"]["losses"]
Skywars Losses Solo -- data["player"]["stats"]["SkyWars"]["losses_solo"]
Skywars Losses Solo Normal -- data["player"]["stats"]["SkyWars"]["losses_solo_normal"]
Skywars Win Streak -- data["player"]["stats"]["SkyWars"]["win_streak"]
Skywars Games Solo -- data["player"]["stats"]["SkyWars"]["games_solo"]
Skywars Wins -- data["player"]["stats"]["SkyWars"]["wins"]
Skywars Wins Solo -- data["player"]["stats"]["SkyWars"]["wins_solo"]
Skywars Wins Solo Normal -- data["player"]["stats"]["SkyWars"]["wins_solo_normal"]
Skywars Kills -- data["player"]["stats"]["SkyWars"]["kills"]
Skywars Kills Solo -- data["player"]["stats"]["SkyWars"]["kills_solo"]
Skywars Kills Solo Normal -- data["player"]["stats"]["SkyWars"]["kills_solo_normal"]
Skywars Souls Gathered -- data["player"]["stats"]["SkyWars"]["souls_gathered"]
Skywars eggs Thrown -- data["player"]["stats"]["SkyWars"]["egg_thrown"]
Skywars Assists -- data["player"]["stats"]["SkyWars"]["assists"]
Skywars Assists Solo -- data["player"]["stats"]["SkyWars"]["assists_solo"]
Skywars Enderpearls Thrown -- data["player"]["stats"]["SkyWars"]["enderpearls_thrown"]
Skywars Deaths Solo Insane -- data["player"]["stats"]["SkyWars"]["deaths_solo_insane"]
Skywars Losses Solo Insane -- data["player"]["stats"]["SkyWars"]["losses_solo_insane"]
Skywars Arrows Hit -- data["player"]["stats"]["SkyWars"]["arrows_hit"]
Skywars Arrows Shot -- data["player"]["stats"]["SkyWars"]["arrows_shot"]
Skywars Deaths Team -- data["player"]["stats"]["SkyWars"]["deaths_team"]
Skywars Deaths Team Insane -- data["player"]["stats"]["SkyWars"]["deaths_team_insane"]
Skywars Losses Team -- data["player"]["stats"]["SkyWars"]["losses_team"]
Skywars Losses Team Insane -- data["player"]["stats"]["SkyWars"]["losses_team_insane"]
Skywars Wins Solo Insane -- data["player"]["stats"]["SkyWars"]["wins_solo_insane"]
Skywars Kills Solo Insane -- data["player"]["stats"]["SkyWars"]["kills_solo_insane"]
Skywars Soul Well -- data["player"]["stats"]["SkyWars"]["soul_well"]
Skywars Soul Well Rares -- data["player"]["stats"]["SkyWars"]["soul_well_rares"]
Skywars Games Team -- data["player"]["stats"]["SkyWars"]["games_team"]
Skywars Heads -- data["player"]["stats"]["SkyWars"]["heads"]
Skywars Heads Decent -- data["player"]["stats"]["SkyWars"]["heads_decent"]
Skywars Heads Decent Team -- data["player"]["stats"]["SkyWars"]["heads_decent_team"]
Skywars Heads Team -- data["player"]["stats"]["SkyWars"]["heads_team"]
Skywars Kills Team -- data["player"]["stats"]["SkyWars"]["kills_team"]
Skywars Kills Team Insane -- data["player"]["stats"]["SkyWars"]["kills_team_insane"]
Skywars Assists Team -- data["player"]["stats"]["SkyWars"]["assists_team"]
Skywars Deaths Team -- data["player"]["stats"]["SkyWars"]["deaths_team_normal"]
Skywars Wins Team -- data["player"]["stats"]["SkyWars"]["wins_team"]
Skywars Wins Team Normal -- data["player"]["stats"]["SkyWars"]["wins_team_normal"]
Skywars Losses Team Normal -- data["player"]["stats"]["SkyWars"]["losses_team_normal"]
Skywars Kills Team Normal -- data["player"]["stats"]["SkyWars"]["kills_team_normal"]
Skywars Soul Well Legendaries -- data["player"]["stats"]["SkyWars"]["soul_well_legendaries"]
Skywars Heads Tasty -- data["player"]["heads_tasty"]
Skywars Heads Tasty Team -- data["player"]["heads_tasty_team"]
Skywars Heads Eww -- data["player"]["stats"]["SkyWars"]["heads_eww"]
Skywars Heads Eww Team -- data["player"]["stats"]["SkyWars"]["heads_eww_team"]
Skywars Heads Meh -- data["player"]["stats"]["SkyWars"]["heads_meh"]
Skywars Heads Meh Team -- data["player"]["stats"]["SkyWars"]["heads_meh_team"]
Skywars Head Yucky -- data["player"]["stats"]["SkyWars"]["heads_yucky"]
Skywars Heads Heavenly -- data["player"]["stats"]["SkyWars"]["heads_heavenly"]
Skywars Heads Divine -- data["player"]["stats"]["SkyWars"]["heads_divine"]
Skywars Heads Salty -- data["player"]["stats"]["SkyWars"]["heads_salty"]
Skywars Heads Succulent -- data["player"]["stats"]["SkyWars"]["heads_succulent"]
BedWars XP -- data["player"]["stats"]["Bedwars"]["Experience"]
Bedwars Winstreak -- data["player"]["stats"]["Bedwars"]["winstreak"]
Bedwars Coins -- data["player"]["stats"]["Bedwars"]["coins"]
Bedwars Deaths -- data["player"]["stats"]["Bedwars"]["deaths"]
Bedwars four_four deaths -- data["player"]["stats"]["Bedwars"]["four_four_deaths_bedwars"]
Bedwars four_four games played -- data["player"]["stats"]["Bedwars"]["four_four_games_played_bedwars"]
Bedwars four_four kills -- data["player"]["stats"]["Bedwars"]["four_four_kills_bedwars"]
Bedwars four_four wins -- data["player"]["stats"]["Bedwars"]["four_four_wins_bedwars"]
Bedwars Games played -- data["player"]["stats"]["Bedwars"]["games_played_bedwars"]
Bedwars Gold resources collected -- data["player"]["stats"]["Bedwars"]["gold_resources_collected_bedwars"]
Bedwars Iron resources collected -- data["player"]["stats"]["Bedwars"]["iron_resources_collected_bedwars"]
Bedwars Kills -- data["player"]["stats"]["Bedwars"]["kills_bedwars"]
Bedwars Wins -- data["player"]["stats"]["Bedwars"]["wins_bedwars"]
Bedwars Beds broken -- data["player"]["stats"]["Bedwars"]["beds_broken_bedwars"]
Bedwars eight_two beds broken -- data["player"]["stats"]["Bedwars"]["eight_two_beds_broken_bedwars"]
Bedwars eight_two beds lost -- data["player"]["stats"]["Bedwars"]["eight_two_beds_lost_bedwars"]
Bedwars eight_two deaths -- data["player"]["stats"]["Bedwars"]["eight_two_deaths_bedwars"]
Bedwars eight_two final deaths -- data["player"]["stats"]["Bedwars"]["eight_two_final_deaths_bedwars"]
Bedwars eight_two final kills -- data["player"]["stats"]["Bedwars"]["eight_two_final_kills_bedwars"]
Bedwars eight_two games played -- data["player"]["stats"]["Bedwars"]["eight_two_games_played_bedwars"]
Bedwars eight_two losses -- data["player"]["stats"]["Bedwars"]["eight_two_losses_bedwars"]
Bedwars final kills -- data["player"]["stats"]["Bedwars"]["final_kills_bedwars"]
Bedwars Losses -- data["player"]["stats"]["Bedwars"]["losses_bedwars"]
Bedwars eight_two kills -- data["player"]["stats"]["Bedwars"]["eight_two_kills_bedwars"]
Bedwars void kills -- data["player"]["stats"]["Bedwars"]["void_kills_bedwars"]
Bedwars emerald resources collected -- data["player"]["stats"]["Bedwars"]["emerald_resources_collected_bedwars"]
Bedwars four_four beds lost -- data["player"]["stats"]["Bedwars"]["four_four_beds_lost_bedwars"]
Bedwars four_four final deaths -- data["player"]["stats"]["Bedwars"]["four_four_final_deaths_bedwars"]
Bedwars four_four losses -- data["player"]["stats"]["Bedwars"]["four_four_losses_bedwars"]
Bedwars two_four beds lost -- data["player"]["stats"]["Bedwars"]["two_four_beds_lost_bedwars"]
Bedwars two_four deaths -- data["player"]["stats"]["Bedwars"]["two_four_deaths_bedwars"]
Bedwars two_four final deaths -- data["player"]["stats"]["Bedwars"]["two_four_final_deaths_bedwars"]
Bedwars two_four games played -- data["player"]["stats"]["Bedwars"]["two_four_games_played_bedwars"]
Bedwars two_four losses -- data["player"]["stats"]["Bedwars"]["two_four_losses_bedwars"]
Bedwars two_four wins -- data["player"]["stats"]["Bedwars"]["two_four_wins_bedwars"]
Bedwars Fall deaths -- data["player"]["stats"]["Bedwars"]["fall_deaths_bedwars"]
Bedwars Fall kills -- data["player"]["stats"]["Bedwars"]["fall_kills_bedwars"]
Bedwars two_four kills -- data["player"]["stats"]["Bedwars"]["two_four_kills_bedwars"]
Bedwars diamond resources collected -- data["player"]["stats"]["Bedwars"]["diamond_resources_collected_bedwars"]
Bedwars four_four void kills -- data["player"]["stats"]["Bedwars"]["four_four_void_kills_bedwars"]
Bedwars four_four_swap beds lost -- data["player"]["stats"]["Bedwars"]["four_four_swap_beds_lost_bedwars"]
Bedwars four_four_swap final deaths -- data["player"]["stats"]["Bedwars"]["four_four_swap_final_deaths_bedwars"]
Bedwars four_four_swap games played -- data["player"]["stats"]["Bedwars"]["four_four_swap_games_played_bedwars"]
Bedwars four_four_swap losses -- data["player"]["stats"]["Bedwars"]["four_four_swap_losses_bedwars"]
Bedwars four_four beds broken -- data["player"]["stats"]["Bedwars"]["four_four_beds_broken_bedwars"]
Bedwars four_four projectile kills -- data["player"]["stats"]["Bedwars"]["four_four_projectile_kills_bedwars"]
Bedwars projectile kills -- data["player"]["stats"]["Bedwars"]["projectile_kills_bedwars"]
Bedwars two_four beds broken -- data["player"]["stats"]["Bedwars"]["two_four_beds_broken_bedwars"]
Bedwars eight_one deaths -- data["player"]["stats"]["Bedwars"]["eight_one_deaths_bedwars"]
Bedwars eight_one final deaths -- data["player"]["stats"]["Bedwars"]["eight_one_final_deaths_bedwars"]
Bedwars eight_one games played -- data["player"]["stats"]["Bedwars"]["eight_one_games_played_bedwars"]
Bedwars eight_one losses -- data["player"]["stats"]["Bedwars"]["eight_one_losses_bedwars"]
Bedwars Beds Lost eight_one -- data["player"]["stats"]["Bedwars"]["eigth_one_beds_lost"]
Bedwars eight_one kills -- data["player"]["stats"]["Bedwars"]["eight_one_kills_bedwars"]
Bedwars four_three_beds_lost -- data["player"]["stats"]["Bedwars"]["four_three_beds_lost_bedwars"]
Bedwars four_three_deaths -- data["player"]["stats"]["Bedwars"]["four_three_deaths_bedwars"]
Bedwars four_three final deaths -- data["player"]["stats"]["Bedwars"]["four_three_final_deaths_bedwars"]
Bedwars four_three games played -- data["player"]["stats"]["Bedwars"]["four_three_games_played_bedwars"]
Bedwars four_three losses -- data["player"]["stats"]["Bedwars"]["four_three_losses_bedwars"]
Bedwars four_three wins -- data["player"]["stats"]["Bedwars"]["four_three_wins_bedwars"]
Bedwars eight_one beds broken -- data["player"]["stats"]["Bedwars"]["eight_one_beds_broken_bedwars"]
Bedwars eight_one final kills -- data["player"]["stats"]["Bedwars"]["eight_one_final_kills_bedwars"]
Bedwars four_three kills -- data["player"]["stats"]["Bedwars"]["four_three_kills_bedwars"]
Bedwars eight_two wins -- data["player"]["stats"]["Bedwars"]["eight_two_wins_bedwars"]
Slumber Item: Bed Sheets -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["bed_sheets"]
Slumber Item: Perfume -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["perfume"]
Slumber Item: Ender Dust -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["ender_dust"]
Slumber Item: Imperial Leather -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["imperial_leather"]
Slumber Item: Indigo's Map -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["indigos_map"]
Slumber Item: Trusty Rope -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["trusty_rope"]
Slumber Item: Golden Ticket -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["golden_ticket"]
Slumber Item: Iron Nugget -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["iron_nugget"]
Slumber Item: Silver Coins -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["silver_coins"]
Slumber Item: Missing Amulet -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["missing_amulet"]
Slumber Item: Soul -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["soul"]
Slumber Item: Comfy Pillow -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["comfy_pillow"]
Slumber Item: Amulet -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["amulet"]
Slumber Item: Weapon Mold -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["weapon_mold"]
Slumber Item: Oasis Water -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["oasis_water"]
Slumber Item: Enchanted Hammer -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["enchanted_hammer"]
Slumber Item: Token of Ferocity -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["token_of_ferocity"]
Slumber Item: Cable -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["cable"]
Slumber Item: Timeworn Mystery Box -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["timeworn_mystery_box"]
Slumber Item: Proof of Success -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["proof_of_success"]
Slumber Item: Gold Bar -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["gold_bar"]
Slumber Item: Spark Plug -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["spark_plug"]
Slumber Item: Ratman Mask -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["ratman_mask"]
Slumber Item: Dwarven Mithril -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["dwarven_mithril"]
Slumber Item: Diamond Fragment -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]"]["item"]["murder_weapon"]
Slumber Item: Limbo Dust -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["limbo_dust"]
Slumber Item: Boots -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["boots"]
Slumber Item: Air Freshener -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["air_freshener"]
Slumber Item: Cleaned Up Murder Knife -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["cleaned_up_murder_knife"]
Slumber Item: Moon Stone Nugget -- data["player"]["stats"]["Bedwars"]["sl["diamond_fragment"]
Slumber Item: Emerald Shard -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["emerald_shard"]
Slumber Item: Unused Bomb Materials -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["unused_bomb_materials"]
Slumber Item: Blitz Star -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["blitz_star"]
Slumber Item: Faded Blitz Star -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["faded_blitz_star"]
Slumber Item: Nether Star -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["nether_star"]
Slumber Item: Silver Blade Replay -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["silver_blade_replay"]
Slumber Item: Gloves -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["gloves"]
Slumber Item: Victim Photo -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["victim_photo"]
Slumber Item: Murder Weapon -- data["player"]["stats"]["Bedwars"]["slumber"]["questumber"]["quest"]["item"]["moon_stone_nugget"]
Slumber Item: Block of Mega Walls Obsidian -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["block_of_mega_walls_obsidian"]
Slumber Item: Discarded Kart Wheel -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["discarded_kart_wheel"]
Slumber Item: Glowing Sand Paper -- data["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["glowing_sand_paper"]
Slumber Hotel: Total Tickets Earned -- data["player"]["stats"]["Bedwars"]["slumber"]["total_tickets_earned"]
"""
...
def get_data(player: str):
    ...
    data = {
        ...
        "Bedwars Deaths": get_or_none(d, ["player", "stats", "Bedwars", "deaths"]),
        ...
        "Slumber Hotel Item: Perfume": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "perfume"]),
        # "Slumber Hotel Item: Bed Sheets": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["bed_sheets"],
        "Slumber Hotel Item: Bed Sheets": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "bed_sheets"]),
        # "Slumber Hotel Item: Ender Dust": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["ender_dust"],
        "Slumber Hotel Item: Ender Dust": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "ender_dust"]),
        # "Slumber Hotel Item: Imperial Leather": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["imperial_leather"],
        "Slumber Hotel Item: Imperial Leather": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "imperial_leather"]),
        # "Slumber Hotel Item: Indigo's Map": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["indigos_map"],
        "Slumber Hotel Item: Indigo's Map": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "indigos_map"]),
        # "Slumber Hotel Item: Trusty Rope": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["trusty_rope"],
        "Slumber Hotel Item: Trusty Rope": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "trusty_rope"]),
        # "Slumber Hotel Item: Golden Ticket": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["golden_ticket"],
        "Slumber Hotel Item: Golden Ticket": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "golden_ticket"]),
        # "Slumber Hotel Item: Iron Nugget": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["iron_nugget"],
        "Slumber Hotel Item: Iron Nugget": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "iron_nugget"]),
        # "Slumber Hotel Item: Silver Coins": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["silver_coins"],
        "Slumber Hotel Item: Silver Coins": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "silver_coins"]),
        # "Slumber Hotel Item: Nether Star": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["nether_star"],
        "Slumber Hotel Item: Nether Star": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "nether_star"]),
        # "Slumber Hotel Item: Missing Amulet": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["missing_amulet"],
        "Slumber Hotel Item: Missing Amulet": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "missing_amulet"]),
        # "Slumber Hotel Item: Soul": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["soul"],
        "Slumber Hotel Item: Soul": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "soul"]),
        # "Slumber Hotel Item: Comfy Pillow": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["comfy_pillow"]
        "Slumber Hotel Item: Comfy Pillow": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "comfy_pillow"]),
        # "Slumber Hotel Item: Amulet": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["amulet"],
        "Slumber Hotel Item: Amulet": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "amulet"]),
        # "Slumber Hotel Item: Weapon Mold": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["weapon_mold"],
        "Slumber Hotel Item: Weapon Mold": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "weapon_mold"]),
        # "Slumber Hotel Item: Oasis Water": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["oasis_water"],
        "Slumber Hotel Item: Oasis Water": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "oasis_water"]),
        # "Slumber Hotel Item: Enchanted Hammer": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["enchanted_hammer"],
        "Slumber Hotel Item: Enchanted Hammer": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "enchanted_hammer"]),
        # "Slumber Hotel Item: Token of Ferocity": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["token_of_ferocity"],
        "Slumber Hotel Item: Token of Ferocity": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "token_of_ferocity"]),
        # "Slumber Hotel Item: Cable": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["cable"],
        "Slumber Hotel Item: Cable": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "cable"]),
        # "Slumber Hotel Item: Timeworn Mystery Box": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["timeworn_mystery_box"],
        "Slumber Hotel Item: Timeworn Mystery Box": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "timeworn_mystery_box"]),
        # "Slumber Hotel Item: Proof of Success": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["proof_of_success"],
        "Slumber Hotel Item: Proof of Success": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "proof_of_success"]),
        # "Slumber Hotel Item: Gold Bar": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["gold_bar"],
        "Slumber Hotel Item: Gold Bar": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "gold_bar"]),
        # "Slumber Hotel Item: Spark Plug": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["spark_plug"],
        "Slumber Hotel Item: Spark Plug": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "spark_plug"]),
        # "Slumber Hotel Item: Ratman Mask": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["ratman_mask"],
        # "Slumber Hotel Item: Ratman Mask": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["ratman_mask"],
        "Slumber Hotel Item: Ratman Mask": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "ratman_mask"]),
        # "Slumber Hotel Item: Dwarven Mithril": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["dwarven_mithril"],
        "Slumber Hotel Item: Dwarven Mithril": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "dwarven_mithril"]),
        # "Slumber Hotel Item: Diamond Fragment": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["diamond_fragment"],
        "Slumber Hotel Item: Diamond Fragment": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "diamond_fragment"]),
        # "Slumber Hotel Item: Limbo Dust": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["limbo_dust"],
        "Slumber Hotel Item: Limbo Dust": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "limbo_dust"]),
        # "Slumber Hotel Item: Boots": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["boots"],
        "Slumber Hotel Item: Boots": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "boots"]),
        # "Slumber Hotel Item: Air Freshener": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["air_freshener"],
        "Slumber Hotel Item: Air Freshener": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "air_freshener"]),
        # "Slumber Hotel Item: Cleaned Up Murder Knife": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["cleaned_up_murder_knife"],
        "Slumber Hotel Item: Cleaned Up Murder Knife": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "cleaned_up_murder_knife"]),
        # "Slumber Hotel Item: Moon Stone Nugget": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["moon_stone_nugget"],
        "Slumber Hotel Item: Moon Stone Nugget": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "moon_stone_nugget"]),
        # "Slumber Hotel Item: Emerald Shard": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["emerald_shard"],
        "Slumber Hotel Item: Emerald Shard": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "emerald_shard"]),
        # "Slumber Hotel Item: Unused Bomb Materials": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["unused_bomb_materials"],
        "Slumber Hotel Item: Unused Bomb Materials": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "unused_bomb_materials"]),
        # "Slumber Hotel Item: Blitz Star": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["blitz_star"],
        "Slumber Hotel Item: Blitz Star": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "blitz_star"]),
        # "Slumber Hotel Item: Faded Blitz Star": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["faded_blitz_star"],
        "Slumber Hotel Item: Faded Blitz Star": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "faded_blitz_star"]),
        # "Slumber Hotel Item: Nether Star": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["nether_star"],
        "Slumber Hotel Item: Nether Star": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "nether_star"]),
        # "Slumber Hotel Item: Silver Blade Replay": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["silver_blade_replay"],
        "Slumber Hotel Item: Silver Blade Replay": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "silver_blade_replay"]),
        # "Slumber Hotel Item: Gloves": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["gloves"],
        "Slumber Hotel Item: Gloves": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "gloves"]),
        # "Slumber Hotel Item: Victim Photo": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["victim_photo"],
        "Slumber Hotel Item: Victim Photo": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "victim_photo"]),
        # "Slumber Hotel Item: Murder Weapon": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["murder_weapon"],
        "Slumber Hotel Item: Murder Weapon": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "murder_weapon"]),
        # "Slumber Hotel Item: Block of Mega Walls Obsidian": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["block_of_mega_walls_obsidian"],
        "Slumber Hotel Item: Block of Mega Walls Obsidian": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "block_of_mega_walls_obsidian"]),
        # "Slumber Hotel Item: Discarded Kart Wheel": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["discarded_kart_wheel"],
        "Slumber Hotel Item: Discarded Kart Wheel": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "discarded_kart_wheel"]),
        # "Slumber Hotel Item: Glowing Sand Paper": d["player"]["stats"]["Bedwars"]["slumber"]["quest"]["item"]["glowing_sand_paper"],
        "Slumber Hotel Item: Glowing Sand Paper": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "quest", "item", "glowing_sand_paper"]),
        # "Slumber Hotel Total Tickets Earned": d["player"]["stats"]["Bedwars"]["slumber"]["total_tickets_earned"],
        "Slumber Hotel Total Tickets Earned": get_or_none(d, ["player", "stats", "Bedwars", "slumber", "total_tickets_earned"]),
    }
    return data
...
def full_data(l, d):
    options = process.extract("bedwars fin kill", l, limit=10, scorer=fuzz.WRatio, processor=preprocess_text)

    filtered = [] 

    for item_tuple in options:
        if item_tuple[1] > 50: 
            filtered.append(item_tuple[0]) 
...
async def on_member_join(member):
    await member.send(f'Welcome {member.name} to the server! \n In this server, you can use commands like !stats <player_name> <mode> to get real player data from Hypixel Public API. \n You can also use !assign to assign yourself the Cringineer role, and !unassign to remove it. \n Enjoy your stats!')
